...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
    ...
    private static function _checkSheetTitle($pValue)
    {
        ...
        // Maximum 1000 characters allowed for sheet title
        if (PHPExcel_Shared_String::CountCharacters($pValue) > 1000) {
            throw new PHPExcel_Exception('Maximum 1000 characters allowed in sheet title.');
        }
